	...
	<body>
		...
		<div class="d-flex justify-content-center">
			<div class="form-group shadow col-md-7">
				...
				<hr />
				<div role="form">
					<form class="form" method="POST" onsubmit="return validar()" action="back/B_EditarUsuario.php" name="form1" id="form1">
						<div class="form group mx-2">
							...
							<div class="form-row  mb-3">
								<div class="col-md-5">
									<input type="text" name="user" id="user" onkeyup="return validar()" class="form-control" required size="50" maxlength="50" pattern="^[a-zA-Z]*$" value="<?php echo $user ?>">
								</div>
							</div>
							...
							<div class="form-row  mb-3">
								<div class="col-md-5">
									<input type="password" name="senha" id="senha" onkeyup="return validar()" class="form-control" required size="100" maxlength="100">
								</div>
							</div>
