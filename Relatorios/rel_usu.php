...
if($n_sql_rel!=0){
	...
	for($x=0; $x < $n_sql_rel; $x++){
			...
			?>
			>
				<td><font size=-1 face=arial><?php echo mysql_result($r_sql_rel, 0, 'ID_TFUN'); ?></font></td>
				<td><font size=-1 face=arial><?php echo mysql_result($r_sql_rel, 0, 'NOME');  ?></font></td>
			</tr>
